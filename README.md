...
| Security Operations (Prevent/Defense) |<a href=https://github.com/NDaria-Cyber/Blocked-Suspicious-Outbound-Activity-via-Firewall-Real-Reconstructed-Incident-> Blocked Suspicious Activity via Firewall (Reconstructed Incident) | 
